...
<head>
    ...
    <title>Tambah Data SCHOOL - aandhen.com</title>
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ route('school.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold">DRESCRIPTION</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" placeholder="Masukkan Status">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('website') is-invalid @enderror" name="website" value="{{ old('website') }}" placeholder="Masukkan Website">
                            ...
                            <div class="form-group">
                                <label class="font-weight-bold">ACCREDITAION</label>
                                <select class="form-control @error('accreditation') is-invalid @enderror" name="accreditation">
                                    <option value="" disabled selected>-- Pilih Status --</option>
